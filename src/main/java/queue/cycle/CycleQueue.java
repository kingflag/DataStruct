...
/**
 * 循环队列
 * Created by King on 2017/11/11.
 */
public class CycleQueue<T> implements Serializable{
     ...
     */
    public CycleQueue(T element, int initSize) {
    ...
    public static void main(String[] args) {
        CycleQueue<String> queue = new CycleQueue<String>("aaaa", 3);
        //添加两个元素
        queue.add("bbbb");
        queue.add("cccc");
        //此时队列已满
